...
--
-- Host: 127.0.0.1
-- Generation Time: Wrz 14, 2026 at 07:45 PM
...
--
-- Struktura tabeli dla tabeli `historia_statusow_rezerwacji`
--
...
--
-- Dumping data for table `historia_statusow_rezerwacji`
--
...
--
-- Struktura tabeli dla tabeli `log_administracyjny`
--
...
--
-- Dumping data for table `log_administracyjny`
--
...
--
-- Struktura tabeli dla tabeli `urlopy_pracownikow`
--
...
--
-- Dumping data for table `urlopy_pracownikow`
--

INSERT INTO `urlopy_pracownikow` (`id`, `pracownik_id`, `data_od`, `data_do`, `powod`, `data_utworzenia`) VALUES
(1, 1, '2026-12-23', '2026-12-31', 'Urlop świąteczny', '2026-09-14 17:44:11');
...
--
-- Indeksy dla tabeli `historia_statusow_rezerwacji`
--
...
--
-- Indeksy dla tabeli `log_administracyjny`
--
...
ALTER TABLE `rezerwacje`
  ...
  ADD KEY `pracownik_id` (`pracownik_id`),
  ADD KEY `usluga_id` (`usluga_id`),
  ADD KEY `idx_pracownik_data` (`pracownik_id`,`data_rezerwacji`),
  ADD KEY `idx_klient_status` (`klient_id`,`status`);

--
-- Indeksy dla tabeli `urlopy_pracownikow`
--
...
ALTER TABLE `uslugi`
  ...
  ADD KEY `idx_kategoria_aktywna` (`kategoria_id`,`aktywna`);
...
--
-- AUTO_INCREMENT for table `historia_statusow_rezerwacji`
--
ALTER TABLE `historia_statusow_rezerwacji`
...
--
-- AUTO_INCREMENT for table `log_administracyjny`
--
ALTER TABLE `log_administracyjny`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `urlopy_pracownikow`
--
ALTER TABLE `urlopy_pracownikow`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `historia_statusow_rezerwacji`
--
ALTER TABLE `historia_statusow_rezerwacji`
...
--
-- Constraints for table `log_administracyjny`
--
ALTER TABLE `log_administracyjny`
...
--
-- Constraints for table `urlopy_pracownikow`
--
ALTER TABLE `urlopy_pracownikow`
